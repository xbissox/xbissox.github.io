<h2> Meu nome é Alessandro Bisso </h2>
...
const xbissox = {
  ...
  <p>ferramentas: [React, Node, Styled-Components, Docker, PySide6, Django, </p> Selenium, Regexp, Testes, TDD, POO, Design Patterns GoF, algoritmos e  programação],
